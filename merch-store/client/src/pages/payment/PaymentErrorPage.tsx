  ...
  return (
    <main className="min-h-screen bg-white px-4 py-10 md:px-8">
      <div className="mx-auto max-w-[760px] rounded-[28px] bg-neutral-50 p-8 text-center">
        <h1 className="text-[32px] font-semibold text-black">Оплата не прошла</h1>
        <p className="mt-4 text-[16px] text-neutral-500">
          Яндекс Пэй вернул ошибку оплаты. Можно попробовать оформить заказ заново или выбрать другой способ оплаты позже.
        </p>
        {orderId && (
